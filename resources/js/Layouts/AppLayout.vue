                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('menus.index')" :active="route().current('menus.index')|| route().current('menus.create')|| route().current('menus.edit',menu)">
                                    Menus
                                </NavLink>
                                <NavLink :href="route('newspapers.index')" :active="route().current('newspapers.index')|| route().current('newspapers.create') || route().current('newspapers.edit',newspaper)">
                                    Newspapers
                                </NavLink>
