                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr v-for="newspaper in newspapers.data" :key="newspaper.id"
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img class="w-10 h-10 rounded-full" :src="newspaper.image"/>
                                        </div>
                                        <span class="font-medium">{{ newspaper.title }}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span v-if="newspaper.status==true"
                                        class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">{{ newspaper.status }}</span>
                                    <span v-else
                                        class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">{{ newspaper.status }}</span>    
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <Link :href="route('newspapers.edit',newspaper.id)">
                                        ...
                                        <Link :href="route('newspapers.destroy',newspaper.id)" method="delete" as="button" type="button">
