...
const form = useForm({
    ads_url: props.advertising.ads_url,
    location: props.advertising.location,
    image: props.advertising.image,
    status: props.advertising.status
})

function updateAdvertising() {
    Inertia.post(`/advertisings/${props.advertising.id}`, {
            _method: 'put',
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <form class="py-4 px-4" @submit.prevent="updateAdvertising">
                        <div class="relative z-0 mb-6 w-full group">
                            <input type="text" name="ads_url" id="ads_url" v-model="form.ads_url"
                            ...
                            <label for="ads_url" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Ads_url</label>
                        </div>
                        <div class="relative z-0 mb-6 w-full group">
                        ...
                        <div class="relative z-0 mb-6 w-full group">
                            ...
                            class="block py-2.5 px-0 w-full text-sm
                                text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
